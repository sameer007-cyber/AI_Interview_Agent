...
export default function HomePage() {
  ...
  const handleStartInterview = async () => {
    ...
    setLoading(true); setError(null);
    try {
      const result = await startInterview(interviewState.sessionId, interviewState.candidateName, interviewState.totalQuestions);
  ...
  const handleReset = () => {
    setStage("landing"); setMessages([]); setError(null);
    setInterviewState({ sessionId: null, candidateName: "", totalQuestions: 5, currentQuestion: 0, averageScore: 0, isComplete: false, resumeFile: null, jdFile: null });
  };
      ...
      <main className="relative flex flex-1 flex-col items-center justify-center px-4 pt-14">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="text-center space-y-5">
            ...
            <div>
              <h1 className="text-4xl font-bold tracking-tight text-stone-900" style={{ fontFamily: "'DM Serif Display', serif" }}>
                AI Interview<br />
        ...
        <main className="relative flex flex-1 flex-col items-center justify-center px-4 pt-14">
          ...
          >
            <motion.div variants={fadeUp} className="text-center">
              <h2 className="text-2xl font-bold text-stone-900" style={{ fontFamily: "'DM Serif Display', serif" }}>
                Upload Documents
              </h2>
          ...
          <AnimatePresence>
            {stage === "complete" && (
              ...
              >
                ...
                <h3 className="mt-4 text-2xl font-bold text-stone-900" style={{ fontFamily: "'DM Serif Display', serif" }}>
                  Interview Complete!
                </h3>
